...
public class LoginActivity extends AppCompatActivity {
    ...
    public void login(final String username, final String password) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ServicesUtil.BASE_URL + "/authenticate",
            ...
            protected Response<String> parseNetworkResponse(NetworkResponse response) {
                ...
                String userId = responseHeaders.get("UserId");
                Log.d("Token", token);
                Log.d("UserId", userId);
                StaticParams.token = token;
                StaticParams.userId = Integer.parseInt(userId);
